...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/ankushbhagats/battery-notifier
    cd battery-notifier
    ```
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/ankushbhagats/battery-notifier/blob/master/LICENSE) file for details.
